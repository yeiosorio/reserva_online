    ...
    <div class="container-fluid">
      <div class="row content_hotel">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         ...
         <a onclick="show_library('create');" ><button type="button" class="btn btn-lg btn-default">Create library</button></a>
         <a onclick="show_library('delete');" ><button type="button" class="btn btn-lg btn-default">Delete & Edit library</button></a>

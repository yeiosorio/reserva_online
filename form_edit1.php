      ...
      <div class="row content_hotel">
        ...
        <a onclick="show_hotel('delete');" ><button type="button" class="btn btn-lg btn-default">Delete & Edit hotel</button></a>
         ...
         $id = $_GET['id'];
          ...
          $con1  = mysql_query("SELECT * FROM tuorism WHERE id='$id'");
          ...
          $des     = $row['description'];
              ?>
          <form action="edit_turism.php" method="POST" role="form">
             <legend>Setting</legend>
          <div class="form-group">
        <div class="setting">
         <label for="">finca:</label><br>
          <input type="text" class="form-control" name="finca"  value="" placeholder="<?php echo $finca; ?>"><br>
          <label for="">ubicacion:</label><br>
          <input type="text" class="form-control" name="ubicacion"  value="" placeholder="<?php echo $ubicacion ?>"><br>
          <label for="">precio:</label><br>
          <input type="text" class="form-control" name="precio"  value="" placeholder="<?php echo  $precio ?>"><br>
          <label for="">Description:</label><br>
          <textarea type="text" class="form-control" name="des"  value="" placeholder="<?php echo $des ?>"></textarea><br>
